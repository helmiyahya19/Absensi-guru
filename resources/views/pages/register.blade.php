                            ...
                            <div class="p-2">
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="divisions_id" id="divisions_id" class="form-control" required>
                                            ...
                                            @foreach($divisions as $division)
                                                <option value="{{ $division->divisions_id }}" {{ old('divisions_id') == $division->id ? 'selected' : '' }}>
                                                    {{ $division->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phonenumber" id="phonenumber" class="form-control" required value="{{ old('phonenumber') }}">
                                        @error('phonenumber')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
