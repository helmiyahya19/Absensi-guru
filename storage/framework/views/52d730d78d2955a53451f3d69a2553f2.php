...
<!-- end page title -->
    ...
    <?php if(auth()->user()->divisions_id == '2'): ?>
    <div class="row">
        <div class="col-6">
            <div class="card mb-3">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\New folder\absen-Guru\resources\views/dashboard/index.blade.php ENDPATH**/ ?>