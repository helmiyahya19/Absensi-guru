                    ...
                    <div class="float-end">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="<?php echo e(asset('assets')); ?>/images/users/avatar-2.jpg"
                                    alt="Header Avatar">
                    ...
                    <div>
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="<?php echo e(asset('assets')); ?>/images/logo-sm.png" alt="" height="20">
                                </span>
                                <span class="logo-lg">
...
<div class="vertical-menu">
    ...
    <div class="h-100">
        ...
        <div class="user-wid text-center py-4">
            <div class="user-img">
                <img src="<?php echo e(asset('assets')); ?>/images/users/avatar-2.jpg" alt="" class="avatar-md mx-auto rounded-circle">
            </div>
...
</html><?php /**PATH C:\Users\PC Of H\Downloads\absensi-laravel-main\resources\views/dashboard/layouts/main.blade.php ENDPATH**/ ?>