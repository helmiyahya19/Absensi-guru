...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/absensi">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Absensi</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/dashboard/employees/create">Tambah Data</a>
                        <a class="collapse-item" href="/dashboard/employees">Karyawan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/dashboard/divisions/create">Tambah Data</a>
                        <a class="collapse-item" href="/dashboard/divisions">Divisi</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/dashboard/pengajuan-admin">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Pengajuan</span></a>
            </li>
            <?php endif; ?>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo e(asset('images')); ?>/profile.webp">
                            </a>
...
</html><?php /**PATH D:\absen-dosen\absen-dosen\resources\views/dashboard/layouts/main.blade.php ENDPATH**/ ?>